...
$$P(\pi_a \mid y^*) =  \dfrac{\binom{N}{y^*} \lambda^{y^*} (1 - \lambda)^{N - y^*}}{\int \binom{N}{y^*} \lambda^{y^*} (1 - \lambda)^{N - y^*} \, d\lambda}\\$$
$$P(\pi_a \mid y^*) = \dfrac{[\pi_a p + (1 - \pi_a)(1 - p)]^{y^*} [(1 - \pi_a)p + (1 - \pi_a)(1 - p)]^{N - y^*} (1 - 2p)}{\int B(1 - p; y^* + 1; N - y^* + 1) - B(p; y + 1; N - y^* + 1)}\\$$
Falta cambiar el denomidar como Z y de ahi desarrollar la integral
...
```{r fig5,echo=FALSE, warning=FALSE, message=FALSE, fig.align = "center", fig.width = 6, fig.height = 3.8, fig.cap="Posterior segun distintas poblaciones"}
