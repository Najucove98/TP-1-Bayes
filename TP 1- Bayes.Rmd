...
El likelihood es una función de cuan probable es un valor especifico de la variable
...
La distribución a posteriori representa una combinación convexa entre la verosimilitud de los datos (Likelihood) y la credibilidad a priori. $$ p(\pi_a/y) \propto p(y/\pi_a).p(\pi_a) $$
...
# Concatenar graficos
combined_plot <- (plt_prior | plt_likelihood | plt_posterior) +
  plot_annotation(
    title = "Gráfico 1.1: etapas del estudio"
  )
