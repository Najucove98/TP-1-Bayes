...
Se detalla el modelo formalizado para cada parte del modelo con sus respectivas variables a utilizar.
PENSAR BIEN QUE MAS SE PUEDE AGREGAR
...
Falta continuar con la integral del denominador
...
```{r fig4,echo=FALSE, fig.align = "center", fig.width = 5, fig.height = 3.5, warning=FALSE}
set.seed(1998)
