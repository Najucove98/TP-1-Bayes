...
post_w <- ggplot(datos_warner_green, aes(x = p, y = posterior, color = Metodo)) +
    ...
    scale_color_manual(values = c("#FBB4AE","#B3CDE3")) + # c("#D95F02", "#1B9E77")
...
```
```{r fig7,echo=FALSE, fig.align = "center", fig.width = 6.5, fig.height = 4, warning=FALSE, fig.cap="Posterior Greenberg y Warner"}
# Concatenar graficos
post_w 
```
